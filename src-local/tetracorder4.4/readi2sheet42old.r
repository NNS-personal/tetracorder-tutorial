...
#########################################################################
	integer*2 i2sht(4000,710)   # buffer to hold I*2 data
#	integer*2 i2sht(1,4852)     # buffer to hold I*2 data

######## select one of the following:
#########################################################################
	character*8000 chibuff(710)  # buffer to read I*2 data
...
######## select one of the following:
#########################################################################
	real*4	specdat(710,4000)   # extracted spectra in BIP format
#	real*4	specdat(4852,1)   # extracted spectra in BIP format

	integer*4 zel

#variables for ENVI data-cube reads
      character*16000 chiline       # buffer to read all data
