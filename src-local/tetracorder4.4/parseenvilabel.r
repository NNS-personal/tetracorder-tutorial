...
#
#  KEL ratfor (GNU-PC Ver. has problem with comment in break statement
#    the close brace gets commented out and parsing has early end error
#
#				break  # this breaks out of the "check do loop"
#
