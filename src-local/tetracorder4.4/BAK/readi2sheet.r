...
#########################################################################
	integer*2 i2sht(1800,410)   # buffer to hold I*2 data
#	integer*2 i2sht(1,4852)   # buffer to hold I*2 data

######## select one of the following:
#########################################################################
	character*3600 chibuff(410) # buffer to read data
#	character*3600 chibuff(4852) # buffer to read data

        equivalence     (i2sht,chibuff)

######## select one of the following:
#########################################################################
	real*4	specdat(410,1800)   # extracted spectra in BIP format
