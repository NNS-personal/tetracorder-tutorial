...
#
	if (ier!=0) {
	 	write (ttyout,*) 'Problems opening data file, quitting'
		stop
	}
...
100	format(a17,1x,f8.4,1x,f6.4,2(1x,f5.3),1x,f5.2,1x,f4.2,1x,i2,1x,f4.2,1x,a8,i6)
110	format(a40,1x,f8.4,1x,f6.4,2(1x,f5.3),1x,f6.3,1x,f4.2,1x,i2,1x,f5.3,
		1x,a20,1x,a8,i6)
