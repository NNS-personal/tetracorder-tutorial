...
93      write (ttyout,100)
	...
	iline = x
	if (iline < 1) iline = 1
	write (ttyout, "(' Printing every',i5,' th line.')") iline
...
4   format(' Number of Channels = ',i4)
...
20  format(//,' Enter input/output FILENAME. (40 characters or less)',
           /,' --------------------------------------|',/)
...
70  format('f20:data from ',a,' w/err')

71  format('f20:data from ',a,'      ')

75  format(' Type FILE ID and record number of specpr data file.',/)

81	format('....INCORRECT RANGE of rows')

%94	format(a,' data point ',i4,'   data = ',1pe15.6,'     ',$)
...
#NONHPUX%123    format(a,' Data point ',i4,'  Data = ',e15.6,'  Error = ',
#NONHPUX%     c e15.6,$)
#SOLARIS%123    format(a,' Data point ',i4,'  Data = ',e15.6,'  Error = ',
#SOLARIS%     c e15.6,$)
#SUNOS%123    format(a,' Data point ',i4,'  Data = ',e15.6,'  Error = ',
#SUNOS%     c e15.6,$)
#DEC%123    format(a,' Data point ',i4,'  Data = ',e15.6,'  Error = ',
#DEC%     c e15.6,$)
#HPUX%123    format(a,' Data point ',i4,'  Data = ',e15.6,'  Error = ',
#HPUX%     c e15.6,$)
#LINUX%123    format(a,' Data point ',i4,'  Data = ',e15.6,'  Error = ',e15.6,$)
#IA64HPUX%123	format(a,' Data point ',i4,'  Data = ',e15.6,'  Error = ',
#IA64HPUX%     e15.6,$)
