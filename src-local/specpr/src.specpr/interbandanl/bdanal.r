subroutine bdanal(lbnd,diff,xmax,xmin)
#
#ccc  name:
#ccc  version date:
...
# RED
  ...
  real*4 xdata(4864), ydata(4864), lbnd, diff
  real*4 xmin,xmax
...
#	
	 ...
	 diff=ubnd-lbnd
	 call er 
	 call replot(ifl1,xmin,xmax,lbnd,xdata,ydata,chan1,chan2)
# store parameters 
...
# redo 
		...
		if (il==ihr) {
	          call er
		  call replot(ifl1,xmin,xmax,lbnd,xdata,datsc1,chan1,chan2)
		  goto 1
 		}
