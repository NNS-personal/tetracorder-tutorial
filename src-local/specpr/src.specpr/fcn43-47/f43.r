...
# 14592/4 = 3648.  thus the sdata array is set to 2,3648
	...
	real*4 sdata(2,3648), zdata(14592)
...
#*********************************************************************
#
# add null loop return KEL June 2009
#  need to debug routine for GNU gfortran
#
	write(*,*) 'FFT routine NOT WORKING yet - need to debug !'
	return
...
619		format ('FFT and Inverse is limited to less ',
                        'than or equal to 3648 channels',/,
                        'at this time.',//,
