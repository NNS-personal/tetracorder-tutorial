...
20  if (igrmod==0) igrmod = 99
	call initt(igrmod)
	open(addlun,status='scratch',access='direct',recl=77824,form='unformatted')
#
#     allocate the title file
#
	open(ttllun,file=TITLE,access='direct',recl=128,form='unformatted')
#
#
...
30  format(1x,72('*'),/,
	...
	1x,72('*'),/,
	1x,18('*'), ' Current program version: 05/24/2004 ',19('*'))

31 format (1x,29('*'),'Unix version',31('*'))
